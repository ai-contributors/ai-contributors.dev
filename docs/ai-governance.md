...
| -------------- | ------------------ | ------------------------------- | ----------------------------------------------------------- | --------------------------------------------------------- | -------- |
| Claude Code    | Anthropic          | Claude Opus 4.7, Claude Fable 5 | Public site/source content and public CI configuration only | Read, summarize, edit, test, audit, and draft PR evidence | Approved |
